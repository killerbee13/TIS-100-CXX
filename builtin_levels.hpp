...
inline constexpr std::array<level_layout, 51> layouts{{
    ...
    {"50370", "IMAGE TEST PATTERN 1", "BBBBCBBBBBBB O2 IMAGE @5"},
    {"51781", "IMAGE TEST PATTERN 2", "CBBBBBBBBBBB O2 IMAGE @5"},
    {"52544", "EXPOSURE MASK VIEWER", "BBBCBBBBBBBB I1 NUMERIC @0 O2 IMAGE @5"},
    {"53897", "HISTOGRAM VIEWER", "BBBBBBBBCBBB I1 NUMERIC @0 O2 IMAGE @5"},
    {"USEG2", "IMAGE CONSOLE SANDBOX", "BBBBBBBBBBBB I1 NUMERIC - O2 IMAGE -"},
    ...
    {"70601", "STORED IMAGE DECODER", "BBBBBBBBBBBB I1 NUMERIC @0 O2 IMAGE @5"},
    {"00.526.6", "SEQUENCE MERGER",
     "BBCBSBBBBBBS I1 NUMERIC @0 I3 NUMERIC @1 O2 NUMERIC @5"},
    {"01.874.8", "INTEGER SERIES CALCULATOR",
     "BBBCBBBBBBBC I1 NUMERIC @0 O1 NUMERIC @5"},
    {"02.981.2", "SEQUENCE RANGE LIMITER",
     "BBBCBBBBBBBB I0 NUMERIC @0 I1 NUMERIC @1; I2 NUMERIC @2 O1 NUMERIC @5"},
    {"03.176.9", "SIGNAL ERROR CORRECTOR",
     "CBBCBBBBBBBB I1 NUMERIC @0 I2 NUMERIC @1 O1 NUMERIC @5 O2 NUMERIC @6"},
    {"04.340.5", "SUBSEQUENCE EXTRACTOR",
     "BBBBBBBBCBBB I1 NUMERIC @0 I2 NUMERIC @1 O2 NUMERIC @5"},
    {"05.647.1", "SIGNAL PRESCALER",
     "BCCCBBBBBBBB I0 NUMERIC @0 O1 NUMERIC @5 O2 NUMERIC @6 O3 NUMERIC @7"},
    {"06.786.0", "SIGNAL AVERAGER",
     "BBBBCBBBBBBB I1 NUMERIC @0 I2 NUMERIC @1 O2 NUMERIC @5"},
    {"07.050.0", "SUBMAXIMUM SELECTOR",
     "BBBBBBBBCBBB I0 NUMERIC @0 I1 NUMERIC @1 I2 NUMERIC @2 I3 "
     "NUMERIC @3 O2 NUMERIC @5"},
    {"08.633.9", "DECIMAL DECOMPOSER",
     "BBBCBBBBBBBB I1 NUMERIC @0 O0 NUMERIC @5 O1 NUMERIC @6 O2 NUMERIC @7"},
    {"09.904.9", "SEQUENCE MODE CALCULATOR",
     "SBSCBBBCBBBC I1 NUMERIC @0 O1 NUMERIC @5"},
    {"10.656.5", "SEQUENCE NORMALIZER",
     "BBSBBBBSBCBB I1 NUMERIC @0 O2 NUMERIC @5"},
    {"11.711.2", "IMAGE TEST PATTERN 3", "CBBBBBBBBBBB O2 NUMERIC @5"},
    {"12.534.4", "IMAGE TEST PATTERN 4", "CBBBBBBBBBBB O2 NUMERIC @5"},
    {"13.370.9", "SPATIAL PATH VIEWER",
     "BBBBBBBBCBBB I1 NUMERIC @0 O2 IMAGE @5"},
    {"14.781.3", "CHARACTER TERMINAL",
     "SBBCBBBBSBBB I1 NUMERIC @0 O2 IMAGE @5"},
    {"15.897.9", "BACK-REFERENCE REIFIER",
     "BBBBBBBBCBBB I1 NUMERIC @0 I2 NUMERIC @1 O2 NUMERIC @5"},
    {"16.212.8", "DYNAMIC PATTERN DETECTOR",
     "BBBBBBBBBBBC I0 NUMERIC @0 I2 NUMERIC @1 O2 NUMERIC @5"},
    {"17.135.0", "SEQUENCE GAP INTERPOLATOR",
     "CBBBCSBSCBBB I2 NUMERIC @0 O2 NUMERIC @5"},
    {"18.427.7", "DECIMAL TO OCTAL CONVERTER",
     "BBBBBBBBCBBB I1 NUMERIC @0 O2 NUMERIC @5"},
    {"19.762.9", "PROLONGED SEQUENCE SORTER",
     "CSBBBBBBBSBB I2 NUMERIC @0 O2 NUMERIC @5"},
    {"20.433.1", "PRIME FACTOR CALCULATOR",
     "BBBCBBBBBBBB I1 NUMERIC @0 O1 NUMERIC @5"},
    {"21.601.6", "SIGNAL EXPONENTIATOR",
     "BBBBSBBSCBBB I1 NUMERIC @0 I2 NUMERIC @1 O2 NUMERIC @5"},
    {"22.280.8", "T20 NODE EMULATOR",
     "BBBBBBBBBBBC I1 NUMERIC @0 I2 NUMERIC @1 O1 NUMERIC @5"},
    {"23.727.9", "T31 NODE EMULATOR",
     "CSBBBBBBBSBB I2 NUMERIC @0 O2 NUMERIC @5"},
    {"24.511.7", "WAVE COLLAPSE SUPERVISOR",
